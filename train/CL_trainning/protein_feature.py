...
def precompute_protein_features(csv_file, output_dir='data/protein_data', 
    ...
    model_name = '../esm_model/esm2_t33_650M_UR50D'
    tokenizer = EsmTokenizer.from_pretrained(model_name)
    base_model = EsmForMaskedLM.from_pretrained(model_name)
    esm_model = PeftModel.from_pretrained(base_model, '../esm_model/lora_esm2_650M/')
    esm_model.eval()
    esm_model.to(device)
    
    print("Loading LayerNormNet model...")
    layernorm_checkpoint = "../data/model/data_dup_supconH_0331.pth"
